    ...
    <header className="w-full py-3 md:py-4 px-4 md:px-6 border-b border-border/50 bg-background/95 backdrop-blur-md sticky top-0 z-50 shadow-sm">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        <div className="flex items-center">
          <Link to="/livefeed" className="flex items-center space-x-3 group">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button variant="ghost" className="flex items-center gap-2 text-foreground/80 hover:text-foreground">
                <span className="font-medium">Our Recording</span>
            ...
            <DropdownMenuContent align="end" className="w-56">
              ...
              >
                ...
                <div>
                  <div className="font-medium">Live Streaming Portfolio</div>
              ...
              >
                ...
                <div>
                  <div className="font-medium">Corporate Photography</div>
              ...
              <SheetContent side="right" className="w-[85vw] sm:w-[360px]">
                ...
                <div className="mt-6 flex flex-col gap-4">
                  <div className="border-b pb-4">
                    <h3 className="text-sm font-semibold text-muted-foreground mb-3">Our Recording</h3>
